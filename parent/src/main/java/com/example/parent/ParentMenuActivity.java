...
//                        .setAction("Action", null).show();
                Intent intent = new Intent(ParentMenuActivity.this,InformationGradeActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_find_teacher) {
            // Handle the find teacher action
        } else if (id == R.id.nav_history) {

        } else if (id == R.id.nav_notifications) {

        } else if (id == R.id.nav_info_user) {
